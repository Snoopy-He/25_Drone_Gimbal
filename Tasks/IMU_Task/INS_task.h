...
typedef struct
{
    IMU_Angle_Data IMU_Angle;
    IMU_Speed_Data IMU_Speed;
    float temperature;
}Imu_Message;

/**
  * @brief          imu IMU_Task, init bmi088, ist8310, calculate the euler angle
...
extern const fp32 *get_INS_complementry_angle_point(void);
